...
public class DayTestDemo {
    ...
    public static void main(String[] args) {
        ...
        int dayofbdy = 0;
        if ( isLeapYear==true && orgMonth <= 2 && orgMonth >=1) {
            dayofbdy = ((bdyDate + month + Ly + rem + yearCode) % 7) - 1;
        }
        else
              dayofbdy = ((bdyDate + month + Ly + rem + yearCode) % 7);
